...
return (
    <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
        ...
        <Title title='Build your Resume' description='Our streamlined process helps you create professional resume in minutes with intelligent AI-powered tools and features.'/>      
