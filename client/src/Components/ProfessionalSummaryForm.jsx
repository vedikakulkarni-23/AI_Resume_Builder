...
const ProfessionalSummaryForm = ({data, onChange, setResumeData}) => {
  ...
  return (
    <div className='space-y-4'>
      ...
      <div className='mt-6'>
        <textarea value={data || ""} onChange={(e)=> onChange(e.target.value)} rows={7} className='w-full p-3 px-4 mt-2 border text-sm border-gray-300 rounded-lg focus:ring focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors resize-none' placeholder='Write compelling professional summary that highlight your key strengths and career objectives...'/>
