...
},
{
    id: "modern",
    name: "Modern",
    preview: "Sleek design wth strategic use of colors and modern font"
},
{
    id: "minimal-image",
    name: "Minimal Image",
...
},
{
    ...
    <div className='relative overflow-visible'>
        ...
        {isOpen && (
            <div className="absolute top-full w-xs max-h-64 overflow-y-auto p-3 mt-2 space-y-3 z-10 bg-white rounded-md border border-gray-200 shadow-sm">
